...
public class EDFoodValues {
    ...
    public static final FoodProperties PEARL_PASTA = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.1F).effect(new MobEffectInstance(ModEffects.NOURISHMENT.get(), 6000, 0), 1F).build();
    public static final FoodProperties ENDER_PAELLA = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.4F).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1800, 0), 1F).effect(new MobEffectInstance(ModEffects.NOURISHMENT.get(), 6000, 0), 1F).build();
    public static final FoodProperties ENDERMITE_STEW = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.4F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 0), 1F).effect(new MobEffectInstance(ModEffects.COMFORT.get(), 6000, 0), 1F).build();
    ...
    public static final FoodProperties TWISTED_CEREAL = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.5F).effect(new MobEffectInstance(EDEffects.PHASING.get(), 1800, 0), 1F).build();
    public static final FoodProperties CHORUS_STEW = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.5F).effect(new MobEffectInstance(EDEffects.PHASING.get(), 200, 0), 1F).effect(new MobEffectInstance(ModEffects.COMFORT.get(), 6000, 0), 1F).build();
